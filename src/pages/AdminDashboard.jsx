...
export const AdminDashboard = () => {
  ...
  if (loading) {
    return (
      <div className="flex h-screen overflow-hidden bg-background-light items-center justify-center">
        <Sidebar />
  ...
  return (
    <div className="bg-background-light text-slate-900 min-h-screen font-display flex overflow-hidden">
      <Sidebar />
