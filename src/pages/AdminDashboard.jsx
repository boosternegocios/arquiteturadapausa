...
export const AdminDashboard = () => {
  ...
  if (loading) {
    return (
      <div className="flex flex-col lg:flex-row h-[100dvh] overflow-hidden bg-background-light items-center justify-center w-full">
        <Sidebar />
  ...
  return (
    <div className="bg-background-light text-slate-900 min-h-screen font-display flex flex-col lg:flex-row h-[100dvh] overflow-hidden">
      <Sidebar />
